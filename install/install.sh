...
# major, runs `npm ci` in backend/, and installs a platform launcher shortcut.
...
echo "  Start        : launch SlopOn from your applications folder/menu,"
echo "                 or run: $install_root/launcher/slopon.sh"
